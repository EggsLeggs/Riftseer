...
For the full type reference — `Card`, `CardRequest`, `ResolvedCard`, `CardSearchOptions`, and all sub-interfaces — see the [`@riftseer/types` Card Types page](/types/card-types).
...
See the [Adding a field checklist](/types/card-types#adding-a-field) in the `@riftseer/types` Card Types page.
