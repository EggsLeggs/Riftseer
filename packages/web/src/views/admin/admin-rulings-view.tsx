...
import {
  ADMIN_RULING_TYPES,
  type AdminRuling,
  type AdminRulingRecordPatch,
  type AdminRulingTarget,
  type AdminRulingTargetInput,
  type AdminRulingTargetKind,
    ...
    <div className="mb-8 rounded-lg border p-4">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <SelectField
          ...
          options={ADMIN_RULING_TYPES.map((value) => ({
            value,
            label: value === "note" ? "Note" : "Ruling",
          }))}
